...
//		this.negCover = new UCCTree(plis.size(), -1);
	...
	private ValidationResult validateSequential(List<UCCTreeElementUCCPair> currentLevel) {
	...
	private ValidationResult validateParallel(List<UCCTreeElementUCCPair> currentLevel) {
		ValidationResult validationResult = new ValidationResult();
