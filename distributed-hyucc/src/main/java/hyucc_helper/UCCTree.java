...
public class UCCTree extends UCCTreeElement {
	...
	public int addUniqueColumnCombinationsInto(/*UniqueColumnCombinationResultReceiver resultReceiver, */ObjectArrayList<ColumnIdentifier> columnIdentifiers, List<PositionListIndex> plis) {
