...
public class UCCTreeElement {
	...
	public int addUniqueColumnCombinationsInto(/*UniqueColumnCombinationResultReceiver resultReceiver, */OpenBitSet ucc, ObjectArrayList<ColumnIdentifier> columnIdentifiers, List<PositionListIndex> plis) {
		int numUCCs = 0;
		if (this.isUCC) {
			...
			//System.out.println(uccResult.toString());
