package fdep_impl;
/*
 * In this version i use default Spark join.
 */
...
public class DistributedFdep2 implements Serializable{
...
//		posCoverTree.filterGeneralizations();
    ...
    private static void negativeCover() {
    	...
    	JavaPairRDD<Tuple2<Integer, Row>, Tuple2<Integer, Row>> joinedPairs = rowMap.cartesian(rowMap);
    	joinedPairs = joinedPairs.filter(new Function<Tuple2<Tuple2<Integer, Row>, Tuple2<Integer, Row>>, Boolean> () {
    		public Boolean call(Tuple2<Tuple2<Integer, Row>, Tuple2<Integer, Row>> t) {
    			if(t._1._1 > t._2._1)
    				return false;
    			return true;
    		}
    	...
    	JavaRDD<OpenBitSet> differenceSetsRDD = joinedPairs.map(
    			new Function<Tuple2<Tuple2<Integer, Row>, Tuple2<Integer, Row>>, OpenBitSet>() {
    				public OpenBitSet call(Tuple2<Tuple2<Integer, Row>, Tuple2<Integer, Row>> t) {
    	...
    	/*JavaRDD<OpenBitSet> combinedDiffSetRDD = differenceSetsRDD.flatMap(new FlatMapFunction<HashSet<OpenBitSet>, OpenBitSet>() {
        	  public Iterable<OpenBitSet> call(HashSet<OpenBitSet> l) {
