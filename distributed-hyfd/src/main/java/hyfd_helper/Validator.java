...
import hyfd_helper.PositionListIndex;
...
public class Validator {
	...
	private ValidationResult validateSequential(List<FDTreeElementLhsPair> currentLevel) {
	...
	private ValidationResult validateParallel(List<FDTreeElementLhsPair> currentLevel) {
		ValidationResult validationResult = new ValidationResult();
	...
	public List<IntegerPair> validatePositiveCover() {
