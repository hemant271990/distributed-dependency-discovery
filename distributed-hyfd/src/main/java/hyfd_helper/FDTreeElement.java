...
import hyfd_helper.ColumnCombination;
import hyfd_helper.ColumnIdentifier;
//import de.metanome.algorithm_integration.result_receiver.ColumnNameMismatchException;
//import de.metanome.algorithm_integration.result_receiver.CouldNotReceiveResultException;
//import de.metanome.algorithm_integration.result_receiver.FunctionalDependencyResultReceiver;
import hyfd_helper.FunctionalDependency;
import hyfd_helper.CollectionUtils;
...
*/
	...
	public int writeFunctionalDependencies( OpenBitSet lhs, ObjectArrayList<ColumnIdentifier> columnIdentifiers,  boolean writeTableNamePrefix) {
		...
		for (int childAttr = 0; childAttr < this.numAttributes; childAttr++) {
			...
			if (element != null) {
				lhs.set(childAttr);
				numFDs += element.writeFunctionalDependencies(lhs, columnIdentifiers, writeTableNamePrefix);
				lhs.clear(childAttr);
			}
		}
		return numFDs;
