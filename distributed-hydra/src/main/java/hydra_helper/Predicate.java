...
public class Predicate implements PartitionRefiner, Serializable/*, de.metanome.algorithm_integration.Predicate*/ {
	...
	public String toString() {
		return "[P: " + operand1.toString() + " " + op.getShortString() + " " + operand2.toString() + "]";
	}
