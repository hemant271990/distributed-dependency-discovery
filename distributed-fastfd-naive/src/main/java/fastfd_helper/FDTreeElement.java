...
//		}
    ...
    public void mergeTree(FDTreeElement t) {
    	FDTreeElement[] children_set1 = this.children;
    	FDTreeElement[] children_set2 = t.children;
    	for(int i = 0; i < maxAttributeNumber; i++) {
    		if(children_set1[i] == null && children_set2[i] != null) {
    			children_set1[i] = new FDTreeElement(maxAttributeNumber);
    			children_set1[i].children = children_set2[i].children;
    			children_set1[i].isfd = children_set2[i].isfd;
    			children_set1[i].rhsAttributes = children_set2[i].rhsAttributes;
    		} else if(children_set1[i] != null && children_set2[i] != null) {
    			children_set1[i].isfd = children_set2[i].isfd;
    			children_set1[i].rhsAttributes.or(children_set2[i].rhsAttributes);
    		}
    	}
    	for(int i = 0; i < maxAttributeNumber; i++) {
    		if(children_set1[i] != null && children_set2[i] != null)
    			children_set1[i].mergeTree(children_set2[i]);
    	}
    }
